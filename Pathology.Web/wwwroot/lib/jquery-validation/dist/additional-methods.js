 ...
 *
 *	<input class="testinfo" name="partnumber">
 *	<input class="testinfo" name="description">
 *
 *	...will validate unless at least one of them is filled.
 *
 * partnumber:	{require_from_group: [1,".testinfo"]},
 * description: {require_from_group: [1,".testinfo"]}
 *
 ...
 *	<input class="testinfo" name="partnumber">
 *	<input class="testinfo" name="description">
 *	<input class="testinfo" name="color">
 *
 *	...will validate unless either at least two of them are filled,
 *	OR none of them are.
 *
 * partnumber:	{skip_or_fill_minimum: [2,".testinfo"]},
 * description: {skip_or_fill_minimum: [2,".testinfo"]},
 * color:		{skip_or_fill_minimum: [2,".testinfo"]}
 *
 * options[0]: number of fields that must be filled in the group
 * options[1]: CSS selector that defines the group of conditionally required fields
 *
